export const mailtoDetailProductDefault = (product: any) => {
  ...
  return `mailto:ventas@diprofire.cl?subject=${subject}&body=${body}`;
}

export const mailtoCartProductsDefault = (cart: any) => {
  ...
  return `mailto:ventas@diprofire.cl?subject=${subject}&body=${bodyText}`;
}
